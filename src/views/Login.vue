        ...
        <section class="bg-gradient-to-t from-transparent to-white py-14 dark:bg-gray-dark dark:to-transparent lg:py-[100px]">
            <div class="container">
                <div class="relative z-10 lg:flex">
                    <div class="heading text-center mb-0 lg:mb-0 lg:w-1/3 ltr:lg:pr-10 ltr:lg:text-left rtl:lg:pl-10 rtl:lg:text-right">
                        <router-link to="/app/signup" class="text-secondary">sign up</router-link>
                        <h6>Dont Have An Account?</h6>                        
                        <h4 class="mb-6 sm:!leading-[50px]">Ready to Get Started?</h4>
                        
                    </div>
                    <form @submit.prevent="login" class="rounded-3xl bg-white px-4 py-12 dark:bg-[#101626] lg:w-2/3 lg:px-8">
                        <div class="relative">
                            <input
                                type="email"
                                name="email"
    ...
    methods: {
      async login() {
        ...
        try {
          ...
          this.$toast.info('Login failed.', error, {
            timeout: 5000,
            });
        }finally {
            this.loading = false;
